...
$result = mysql_query("SELECT * FROM mappoint WHERE type='$category'");
if(mysql_num_rows($result)>0)
{
while ($mar = mysql_fetch_array($result))
{
if($mar['type'] == 'torgovye') {$cattype = "Торговые точки";}
if($mar['type'] == 'rynki') {$cattype = "Рынки";}
if($mar['type'] == 'kiosk') {$cattype = "Киоск";}
//if($mar['type'] == 'agriko') {$cattype = "Агрико";}
